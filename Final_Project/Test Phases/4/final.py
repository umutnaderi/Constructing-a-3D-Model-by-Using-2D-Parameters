...
scale01.Placement.Base = App.Vector(408,374,503)
scale01.Placement.Rotation = App.Rotation(App.Vector(0,1,0),0.567266)
scale01.Placement.Rotation = App.Rotation(App.Vector(1,0,0),-0.734521)
scale01.Scale = (22.4455,22.2875,9.14286)
scale02.Placement.Base = App.Vector(410,373,439)
scale02.Placement.Rotation = App.Rotation(App.Vector(0,1,0),0.278133)
scale02.Placement.Rotation = App.Rotation(App.Vector(1,0,0),-1.08776)
scale02.Scale = (22.8892,22.5755,9.14286)
scale11.Placement.Base = App.Vector(408,375,413)
...
scale11.Scale = (32.5563,22.2857,9.71429)
scale12.Placement.Base = App.Vector(408,374,345)
scale12.Placement.Rotation = App.Rotation(App.Vector(0,1,0),0.392431)
scale12.Placement.Rotation = App.Rotation(App.Vector(1,0,0),0.364936)
scale12.Scale = (32.4452,22.429,9.71429)
scale21.Placement.Base = App.Vector(407,374,320)
scale21.Placement.Rotation = App.Rotation(App.Vector(0,1,0),-0.154436)
scale21.Placement.Rotation = App.Rotation(App.Vector(1,0,0),-0.739259)
scale21.Scale = (41.2224,22.2875,9.71429)
scale22.Placement.Base = App.Vector(410,375,252)
scale22.Placement.Rotation = App.Rotation(App.Vector(0,1,0),0.194222)
scale22.Placement.Rotation = App.Rotation(App.Vector(1,0,0),-1.10881)
scale22.Scale = (32.778,22.147,9.71429)
scale31.Placement.Base = App.Vector(408,376,226)
scale31.Placement.Rotation = App.Rotation(App.Vector(0,1,0),0.814577)
scale31.Placement.Rotation = App.Rotation(App.Vector(1,0,0),-0.725224)
scale31.Scale = (23.4468,22.5732,9.42857)
scale32.Placement.Base = App.Vector(410,374,160)
scale32.Placement.Rotation = App.Rotation(App.Vector(0,1,0),-0.391091)
scale32.Placement.Rotation = App.Rotation(App.Vector(1,0,0),-0.729843)
scale32.Scale = (32.5563,22.4304,9.42857)
scale41.Placement.Base = App.Vector(408,375,135)
scale41.Placement.Rotation = App.Rotation(App.Vector(0,1,0),0)
scale41.Placement.Rotation = App.Rotation(App.Vector(1,0,0),-1.45945)
scale41.Scale = (32.2222,22.4359,9.57143)
scale42.Placement.Base = App.Vector(408,375,68)
scale42.Placement.Rotation = App.Rotation(App.Vector(0,1,0),0)
scale42.Placement.Rotation = App.Rotation(App.Vector(1,0,0),0.35587)
scale42.Scale = (32.7778,23.0004,9.57143)
FreeCAD.ActiveDocument.recompute()
Gui.SendMsgToActiveView("ViewFit")
Gui.activeDocument().activeView().viewAxonometric()
